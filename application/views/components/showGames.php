...
<div class="eight wide mobile four wide tablet four wide computer stackable column left aligned"  style="margin-bottom: 10px;">
    <div class="row">
        ...
        <div class="ui fluid teal card" style="background-color: #222831; box-shadow: none;">
            ...
            <div class="extra content">
                <div class="right floated author">
                    <a href="" class="ui green icon button"><i class="ellipsis horizontal icon"></i></a>
